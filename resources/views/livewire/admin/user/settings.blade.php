        ...
        <div class="col-lg-12">
            <div class="page-content my-account__edit">
                <div class="my-account__edit-form">
                    <form name="account_edit_form" method="POST"
                        ...
                        <fieldset class="name">
                            ...
                            <input class="flex-grow" type="text" placeholder="Full Name" name="name"
                                tabindex="0" value="" aria-required="true" required="" wire:model="name">
                            @error('name')
                        ...
                        <fieldset class="name">
                            ...
                            <input class="flex-grow" type="text" placeholder="Mobile Number" name="mobile"
                                tabindex="0" value="" aria-required="true" required="" wire:model="phone">
                            @error('phone')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </fieldset>
                        ...
                        <fieldset class="name">
                            ...
                            <input class="flex-grow" type="text" placeholder="Email Address" name="email"
                                tabindex="0" value="" aria-required="true" required="" wire:model="email">
                            @error('email')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </fieldset>
                            ...
                            <div class="col-md-12">
                                <fieldset class="name">
                                    ...
                                    <input class="flex-grow" type="password" placeholder="Old password"
                                        id="current_password" name="current_password" aria-required="true"
