...
<div class="main-content-wrap">
    ...
    <!-- new-brand -->
    <div class="wg-box">
        <form class="form-new-product form-style-1" wire:submit.prevent="updateBrand()" action="" method="POST"
            ...
            <fieldset class="name">
                ...
                <input class="flex-grow" type="text" placeholder="Brand name" name="name" tabindex="0"
                    value="{{ $name }}" aria-required="true" required="" wire:model.lazy='name'>
            </fieldset>
            <fieldset class="name">
                ...
                <div class="upload-image flex-grow">
                    ...
                    <div id="upload-file" class="item up-load">
                        <label class="uploadfile" for="myFile">
                            ...
                            <span class="body-text">Drop your image here or select <span class="tf-color">click
                                    to browse</span></span>
                            <input type="file" id="myFile" name="image" accept="image" wire:model.live='image'>
                        </label>
                    </div>
                </div>
            </fieldset>
