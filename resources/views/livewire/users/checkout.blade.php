<main class="pt-90">
    ...
    <section class="shop-checkout container">
        ...
        <form name="checkout-form" action="" wire:submit.prevent="save">
                    ...
                    <div class="row mt-5">
                        <div class="col-md-6">
                            <div class="form-floating my-3">
                                <input type="text" class="form-control" name="name" required="" wire:model="full_name">
                        ...
                        <div class="col-md-6">
                            <div class="form-floating my-3">
                                <input type="text" class="form-control" name="phone" required="" wire:model="phone">
                        ...
                        <div class="col-md-4">
                            <div class="form-floating my-3">
                                <input type="text" class="form-control" name="zip" required="" wire:model="pincode">
                        ...
                        <div class="col-md-4">
                            <div class="form-floating mt-3 mb-3">
                                <input type="text" class="form-control" name="state" required="" wire:model="state">
                        ...
                        <div class="col-md-4">
                            <div class="form-floating my-3">
                                <input type="text" class="form-control" name="city" required="" wire:model="town">
                        ...
                        <div class="col-md-6">
                            <div class="form-floating my-3">
                                <input type="text" class="form-control" name="address" required="" wire:model="no_building">
                        ...
                        <div class="col-md-6">
                            <div class="form-floating my-3">
                                <input type="text" class="form-control" name="locality" required="" wire:model="area">
                        ...
                        <div class="col-md-12">
                            <div class="form-floating my-3">
                                <input type="text" class="form-control" name="landmark" required="" wire:model="landmark">
                        ...
                        <div class="checkout__totals">
                            ...
                            <table class="checkout-totals">
                                <tbody>
                                    <tr>
                                        <th>SUBTOTAL</th>
                                        <td align="right">${{ session('total') ??  0 }}</td>
                                    </tr>
                                    <tr>
                                        <th>SHIPPING</th>
