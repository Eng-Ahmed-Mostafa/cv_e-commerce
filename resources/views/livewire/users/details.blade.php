                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide product-single__image-item">
                                    <img loading="lazy" class="h-auto" src="{{ asset('storage/'.$product->image) }}"
                                        width="674" height="674" alt="{{ asset('storage/'.$product->image) }}" />
                    ...
                    <div class="product-single__addtocart">
                        <div class="qty-control position-relative">
                            <input type="number" name="quantity" value="1" min="1"
                                class="qty-control__number text-center" wire:model="quantity" max="{{ $quantity }}">
                    ...
                    @foreach ($products as $prod)
                        ...
                        <div class="swiper-slide product-card">
                            <div class="pc__img-wrapper">
                                <a href="{{ route('details',['product'=>$prod->id]) }}">
                                    <img loading="lazy" src="{{ asset('storage/'.$prod->image) }}" width="330"
                                        height="400" alt="Cropped Faux leather Jacket" class="pc__img">
                                    @php

                                        $decoded_prod = json_decode($prod->images,true);

                                        $images_prod = is_array($decoded_prod) ? $decoded_prod : [$prod->images];
                                    @endphp
                                    @if ($images_prod)
                                        <img loading="lazy" src="{{ asset('storage/'.$images_prod[0]) }}" width="330"
                            ...
                            <div class="pc__info position-relative">
                                <p class="pc__category">{{ $prod->name }}</p>
                                <h6 class="pc__title"><a href="{{ route('details',['product'=>$prod->id]) }}">{{ $prod->name }}</a></h6>
                                <div class="product-card__price d-flex">
                                    <span class="money price">${{ $prod->sale_price }}</span>
                                </div>
