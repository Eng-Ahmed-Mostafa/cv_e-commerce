...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('asset_admin/css/animate.min.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('asset_admin/css/animation.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('asset_admin/css/bootstrap.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('asset_admin/css/bootstrap-select.min.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('asset_admin/css/style.css') }}">
    <link rel="stylesheet" href="{{ asset('asset_admin/font/fonts.css') }}">
    <link rel="stylesheet" href="{{ asset('asset_admin/icon/style.css') }}">
                        ...
                        <div class="center-item">
                            <ul class="menu-list">
                                ...
                                <li class="menu-item has-children">
                                    ...
                                    <ul class="sub-menu">
                                        <li class="sub-menu-item">
                                            <a href="{{ route('admin.category.create') }}" class="" wire:navigate>
                                                <div class="text">New Category</div>
                                            </a>
                                        </li>
                                        <li class="sub-menu-item">
                                            <a href="{{ route('admin.category') }}" class="" wire:navigate>
                                ...
                                <li class="menu-item">
                                    <form method="POST" action="{{ route('logout') }}">
                                        @csrf
                                        <button type="submit" class="flex items-center gap-2 bg-transparent border-0 ps-4 fs-3">
                    ...
                    <div class="header-dashboard">
                        <div class="wrap">
                            <div class="header-left">
                                <a href="index-2.html">
                                    <img class="" id="logo_header_mobile" alt="" src="{{ asset('asset_admin/images/logo/logo.png') }}"
                                        data-light="{{ asset('asset_admin/images/logo/logo.png') }}" data-dark="{{ asset('asset_admin/images/logo/logo.png') }}"
                                        data-width="154px" data-height="52px" data-retina="{{ asset('asset_admin/images/logo/logo.png') }}">
                                </a>
                                <div class="button-show-hide">
                                    <i class="icon-menu-left"></i>
                                </div>
                                                ...
                                                <ul>
                                                    <li class="product-item gap14 mb-10">
                                                        <div class="image no-bg">
                                                            <img src="{{ asset('asset_admin/images/products/17.png') }}" alt="">
                                                        </div>
                                                    ...
                                                    <li class="product-item gap14 mb-10">
                                                        <div class="image no-bg">
                                                            <img src="{{ asset('asset_admin/images/products/18.png') }}" alt="">
                                                        </div>
                                                        <div class="flex items-center justify-between gap20 flex-grow">
                                                            <div class="name">
                                                    ...
                                                    <li class="product-item gap14">
                                                        <div class="image no-bg">
                                                            <img src="{{ asset('asset_admin/images/products/19.png') }}" alt="">
                                                        </div>
                                                        <div class="flex items-center justify-between gap20 flex-grow">
                                                            <div class="name">
                                        ...
                                        <ul class="">
                                            ...
                                            <li>
                                                <ul>
                                                    <li class="product-item gap14 mb-10">
                                                        <div class="image no-bg">
                                                            <img src="{{ asset('asset_admin/images/products/20.png') }}" alt="">
                                                        </div>
                                                        <div class="flex items-center justify-between gap20 flex-grow">
                                                            <div class="name">
                                                    ...
                                                    <li class="product-item gap14 mb-10">
                                                        <div class="image no-bg">
                                                            <img src="{{ asset('asset_admin/images/products/21.png') }}" alt="">
                                                        </div>
                                                        <div class="flex items-center justify-between gap20 flex-grow">
                                                            <div class="name">
                                                    ...
                                                    <li class="product-item gap14 mb-10">
                                                        <div class="image no-bg">
                                                            <img src="{{ asset('asset_admin/images/products/22.png') }}" alt="">
                                                        </div>
                                                        <div class="flex items-center justify-between gap20 flex-grow">
                                                            <div class="name">
                                                    ...
                                                    <li class="product-item gap14">
                                                        <div class="image no-bg">
                                                            <img src="{{ asset('asset_admin/images/products/23.png') }}" alt="">
                                                        </div>
                                                        <div class="flex items-center justify-between gap20 flex-grow">
                                                            <div class="name">
                                                                <a href="product-list.html" class="body-text">Mega
                                    ...
                                    <div class="dropdown">
                                        <button class="btn btn-secondary dropdown-toggle" type="button"
                                            ...
                                            <span class="header-user wg-user">
                                                <span class="image">
                                                    <img src="{{ asset('asset_admin/images/avatar/user-1.png') }}" alt="">
                                                </span>
